package com.zozak.event_ticket.controllers;
...
public class EventController {
    ...
    public ResponseEntity<CreateEventResponseDto> createEvent(
        ...
        CreateEventRequest createEventRequest = eventMapper.fromDto(
        ...
        CreateEventResponseDto createEventResponseDto = eventMapper.toDto(
            createdEvent
        );
